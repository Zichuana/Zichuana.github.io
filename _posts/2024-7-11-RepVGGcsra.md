...
title:      RepVGG+CSRA              # 标题 
subtitle:   记录论文中提到的repvgg_b0与csra模块结合方法
date:       2024-7-11              # 时间
author:     zichuana                     # 作者
header-img: img/2024-7-11/a.png    #这篇文章标题背景图片
catalog: true                       # 是否归档
tags:                               #标签
    - paper
    - 深度学习
---
>论文链接:[https://pubmed.ncbi.nlm.nih.gov/37795420/](https://pubmed.ncbi.nlm.nih.gov/37795420/)
